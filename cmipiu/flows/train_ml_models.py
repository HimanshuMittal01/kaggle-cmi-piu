...
from metaflow import FlowSpec, Flow, Run, step, Parameter, IncludeFile
...
class TrainFlow(FlowSpec):
    ...
    def start(self):
        ...
        self.train_parameters = {model.name: train_config[model.value] for model in ModelLevel0}
    ...
    def train_model_level2(self):
        ...
        self.coeffs, self.thresholds = find_coeffs(dataset['df']['sii'], *level1_oof_preds, [0.5, 1.5, 2.5])
